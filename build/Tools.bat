...
set gen=%root%\%proj%\src\main\java\net\certiv\antlr\xvisitor\parser\gen
...
set xvisitor=%jlib%\xvisitor-4.5.3.jar
...
java org.antlr.v4.Tool  -visitor ../XVisitorLexer.g4 ../XVisitorParser.g4
echo Grammars generated

rem java net.certiv.antlr.xvisitor.Tool -v warn ../Outline.xv ../Indent.xv ../Format.xv
rem echo XVisitors generated
